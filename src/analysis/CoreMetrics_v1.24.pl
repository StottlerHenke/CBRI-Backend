...
<header>
    <div id="topbox-container">
        <div id="topbox">
            ...
            <span class=controller style="width:14%">
                <button id=metricsbtn onclick="metricsBtnPress()">Hide Metrics</button></span>
            <span class=controller style="width:14%">
                <button id=descbtn onclick="descBtnPress()">Hide Description</button></span>
            <span class=controller style="width:35%">Zoom:<input name="zoom" type="range" name="points" min="0" max="10"
                                                                 value="1" oninput="setZoom(this.value)"
                                                                 onchange="setZoom(this.value)" onmouseup="draw()">
